		...
		<form on:submit|preventDefault={updateAccount} class="space-y-6" autocomplete="off">
			...
			<div class="flex justify-end space-x-3">
				...
				<button
					...
					class="rounded-xl bg-indigo-600 px-6 py-3 text-white transition-all duration-200 hover:bg-indigo-700 disabled:cursor-not-allowed disabled:opacity-50 disabled:hover:bg-indigo-600 flex items-center justify-center"
				>
					{#if isLoading}
